...
public class Chunk : ISaveable
{
    ...
    private List<Vector2I> spawnedAi;

    public Chunk(Vector2I position)
    {
        _position = position;
        lights = new List<Light>();
        spawnedAi = new List<Vector2I>();
    }
    ...
    public void setTile(Tile tile, Vector2I pos)
    {
        try
        {
            _tiles[pos.x, pos.y, 0] = tile;  //Removing Block step 1 ani
            setDirtyState(true);
        }
        catch
        {
    ...
    public void setBackgroundTile(Tile tile, Vector2I pos)
    {
        try
        {
            _tiles[pos.x, pos.y, 1] = tile;
            setDirtyState(true);
        }
        catch
        {
    ...
    public void AddSpawnedAi(Vector2I pos)
    {
        spawnedAi.Add(pos);
    }

    public bool IsAiSpawned(Vector2I pos)
    {
        return spawnedAi.Contains(pos);
    }
