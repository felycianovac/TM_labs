...
public class Heart : MonoBehaviour {
	...
	public void Hit(){
		if(curr_sprite_index>0){
            ...
            Vector2 playerPos = World.instance.PositionFromMapName(World.instance.mapName);
            World.instance.playerObj.transform.position = new Vector3(playerPos.x, playerPos.y, 1.0f);
            SetSpriteIdx(health.Length - 1);
        }
	}
}
